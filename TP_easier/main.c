...
int main(int argc, char* argv[])
{
  ...
  pthread_mutexattr_setprotocol(&mutex_attr1, PTHREAD_PRIO_PROTECT);
  pthread_mutexattr_setprioceiling(&mutex_attr1, 5);
  pthread_mutexattr_t mutex_attr2;
  pthread_mutexattr_setprotocol(&mutex_attr2, PTHREAD_PRIO_PROTECT);
  pthread_mutexattr_setprioceiling(&mutex_attr2, 5);

  pthread_mutex_init(&lock1, &mutex_attr1);
  pthread_mutex_init(&lock2, &mutex_attr2);
  ...
  /* Q1: to be completed. Make sure the main does not abort threads.
   */
